...
import OOP_Homework4.Planner.util.WriteToJSON;
...
public class Controller {
    ...
    public static void controller() {
        ...
        Components data1 = new Components(2, 3, "Tomas Wane");
        ...
        writer.writeJson(writer.createJsonArray(plannerService1), "PlannerService.json");
        ReadFromJson jsonReader = new ReadFromJson();
        PlannerService plannerService2 = jsonReader.readJson("PlannerService.json");
        logPlanner.info("\n" + plannerService2.toString());
    }
